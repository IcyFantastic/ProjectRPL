...
public class LoginController {
    ...
    private void handleLogin(ActionEvent event) throws Exception {
        ...
        for (User user : users) {
            if (user.getUsername().equals(u) && user.getPassword().equals(p)) {
                ...
                s.setOnCloseRequest((WindowEvent _) -> Storage.saveAll());
                return;
            }
        }
    ...
    private void openRegister(ActionEvent event) throws Exception {
        ...
        Stage s = (Stage) usernameField.getScene().getWindow();
        s.setScene(new Scene(FXMLLoader.load(Objects.requireNonNull(getClass().getResource("/fxml/register-view.fxml")))));
        s.setTitle("Register");
    }
    ...
    private void openReset(ActionEvent event) throws IOException {
        ...
        Stage s = (Stage) usernameField.getScene().getWindow();
        s.setScene(new Scene(FXMLLoader.load(Objects.requireNonNull(getClass().getResource("/fxml/reset-password-view.fxml")))));
    ...
    private void goToResetPassword() throws Exception {
        Stage s = (Stage) usernameField.getScene().getWindow();
        Scene resetScene = new Scene(FXMLLoader.load(Objects.requireNonNull(getClass().getResource("/fxml/reset-password-view.fxml"))));
